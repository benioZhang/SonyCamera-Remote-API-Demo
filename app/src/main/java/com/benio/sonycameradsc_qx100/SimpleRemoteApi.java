...
import com.benio.sonycameradsc_qx100.utils.SimpleHttpClient;
...
public class SimpleRemoteApi {
    ...
    /**
     * Calls setTouchAFPosition API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
    ...
    /**
     * Calls setIsoSpeedRate API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
     ...
     *                     Exception.
     */
    public JSONObject setIsoSpeedRate(String rate) throws IOException {
        String service = "camera";
        try {
            JSONObject requestJson =
                    new JSONObject().put("method", "setIsoSpeedRate") //
                            .put("params", new JSONArray().put(rate)) //
                            .put("id", id()).put("version", "1.0");
            String url = findActionListUrl(service) + "/" + service;
    ...
    /**
     * Calls getAvailableIsoSpeedRate API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
    ...
    /**
     * Calls setShutterSpeed API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
     ...
     *                     Exception.
     */
    public JSONObject setShutterSpeed(String speed) throws IOException {
        String service = "camera";
        try {
            JSONObject requestJson =
                    new JSONObject().put("method", "setShutterSpeed") //
                            .put("params", new JSONArray().put(speed)) //
                            .put("id", id()).put("version", "1.0");
            String url = findActionListUrl(service) + "/" + service;
    ...
    /**
     * Calls getAvailableShutterSpeed API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
    ...
    /**
     * Calls getSupportedShutterSpeed API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
    ...
    /**
     * Calls setLiveviewFrameInfo API to the target server. Request JSON data is
     * such like as below.
     * <p/>
     * <pre>
     * {
     *   "method": "setLiveviewFrameInfo",
     *   "params": [{ "frameInfo": true }],
     *   "id": 1,
     *   "version": "1.0"
     * }
     * </pre>
        ...
        try {
            JSONObject requestJson =
                    new JSONObject().put("method", "setLiveviewFrameInfo") //
                            .put("params", new JSONArray().put(new JSONObject().put("frameInfo", frameInfo))) //
                            .put("id", id()).put("version", "1.0");
            String url = findActionListUrl(service) + "/" + service;
